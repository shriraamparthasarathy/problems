...
public class MaxLenUnsortedSubarray 
{

	static void findIndices(int a[])
	{
		int n=a.length;
		int s,e,max,min;
		...
		System.out.println("The unsorted subarray indices "+s+" and "+e);
	}
	public static void main(String[] args) 
	{
		int a[]= {10, 12, 20, 30, 25, 40, 32, 31, 35, 50, 60};//0, 1, 15, 25, 6, 7, 30, 40, 50
		findIndices(a);
